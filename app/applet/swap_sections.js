...
if (lines[aboutStart - 1].includes('{/* Gaps in Care */}') || lines[aboutStart - 1].includes('{/* ')) {
...
if (lines[pipelineStart - 1].includes('{/* NEW SECTION') || lines[pipelineStart - 1].includes('{/* ')) {
...
if (lines[globalStart - 1].includes('{/* Global Strategy */}') || lines[globalStart - 1].includes('{/* ')) {
