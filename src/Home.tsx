      ...
      <div className="flex justify-center mb-6">
        <div className="bg-slate-100 p-1 rounded-xl inline-flex relative shadow-inner">
          ...
          <div 
            ...
            style={{ 
              transform: `translateX(${activeTab === 'pipeline' ? '4px' : '100%'})`,
            }}
          />
        </div>
      </div>
      ...
      <div className="w-full">
        {activeTab === 'pipeline' && (
          <motion.div
            ...
            className="grid grid-cols-1 md:grid-cols-12 gap-5 items-center bg-white border border-slate-200 rounded-2xl p-3 shadow-sm"
          >
            <div className="md:col-span-7 bg-slate-50 border border-slate-100 rounded-xl overflow-hidden flex items-center justify-center p-2 h-[200px] md:h-[280px]">
              <img 
                src="/pipeline.png" 
                alt="AI 학습 시스템 구조도" 
            ...
            <div className="md:col-span-5 px-2 md:px-4 py-2">
              <div className="inline-flex items-center px-2 py-1 rounded bg-blue-50 text-blue-600 text-[9px] font-bold mb-2 uppercase tracking-widest">
                MLOps Pipeline
              </div>
              <h3 className="text-base md:text-lg font-bold text-slate-900 mb-2 tracking-tight">AI 학습 시스템 구조도</h3>
              <p className="text-slate-500 text-[11px] md:text-xs leading-relaxed mb-4">
              ...
              <div className="space-y-2">
                <div className="flex items-start">
                  ...
                  <span className="text-[10px] md:text-[11px] font-medium text-slate-600 ml-2">Phase 1~5 자동화 파이프라인 데이터 흐름 구성</span>
                </div>
                <div className="flex items-start">
                  <CheckCircle2 className="w-3 h-3 text-blue-500 mt-0.5 flex-shrink-0" />
                  <span className="text-[10px] md:text-[11px] font-medium text-slate-600 ml-2">W&B 실험 모니터링 기반 오경보 케이스 지속 수집</span>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        {activeTab === 'architecture' && (
          ...
          >
            ...
            <div className="md:col-span-5 px-2 md:px-4 py-2">
              <div className="inline-flex items-center px-2 py-1 rounded bg-indigo-50 text-indigo-600 text-[9px] font-bold mb-2 uppercase tracking-widest">
                5-Layer Architecture
              </div>
              <h3 className="text-base md:text-lg font-bold text-slate-900 mb-2 tracking-tight">시스템 블록 아키텍처</h3>
              <p className="text-slate-500 text-[11px] md:text-xs leading-relaxed mb-4">
                멀티센서 디바이스 통합 관제를 위한 5계층 아키텍처입니다. 로컬 엣지 환경에서 최적화된 행동 분류 및 sLLM 추론 엔진을 동작시켜 3초 이내의 빠른 E2E 지연시간을 확보합니다.
              </p>
              <div className="space-y-2">
                <div className="flex items-start">
                  <Cpu className="w-3 h-3 text-indigo-500 mt-0.5 flex-shrink-0" />
                  <span className="text-[10px] md:text-[11px] font-medium text-slate-600 ml-2">NVIDIA 엣지 통합 및 다중 어드민 기반 (RBAC) </span>
                </div>
                <div className="flex items-start">
                  <Shield className="w-3 h-3 text-indigo-500 mt-0.5 flex-shrink-0" />
                  <span className="text-[10px] md:text-[11px] font-medium text-slate-600 ml-2">시각 정보 수집 없이 프라이버시가 보호되는 데이터 설계</span>
                </div>
              </div>
            </div>
          </motion.div>
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 selection:bg-blue-200">
      ...
      <section className="py-12 md:py-16 bg-white border-b border-slate-200">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-50px" }} transition={{ duration: 0.6, ease: "easeOut" }} className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 mb-1 tracking-tight">Tech Stack</h2>
            <p className="text-blue-600 text-xs md:text-sm font-semibold tracking-wide mb-3">시스템 아키텍처 및 AI 학습 파이프라인</p>
            <p className="text-slate-500 text-sm md:text-base font-medium max-w-2xl mx-auto">
              엣지 디바이스부터 클라우드까지 이어지는 확장 가능한 엔드투엔드 인프라와, 지속적인 성능 향상을 위한 자동화된 MLOps 파이프라인 구조를 소개합니다.
            </p>
          </div>
